...
class ReviewerAgent(BaseAgent):
    def __init__(self, llm: LLM, tool_selector: ToolSelector, skill_selector: SkillSelector):
        ...
        self.allowed_capabilities.extend([ToolCapability.MODIFY_TASKS, ToolCapability.SAVE_TASKS, ToolCapability.WRITE_TASK_LOGS, ToolCapability.RUN_TESTS, ToolCapability.GET_CODE_CHANGES])
